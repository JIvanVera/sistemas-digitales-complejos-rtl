// ============================================================
//  LAB 3: Asynchronous Reset Synchronization (Async Assert / Sync Release)
// ============================================================
//
//  Goal:
//  ------
//  Learn how to safely distribute an asynchronous reset across
//  synchronous logic by using a reset synchronizer that ensures
